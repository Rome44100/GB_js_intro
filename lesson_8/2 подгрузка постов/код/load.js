...
// Сделал, но работает не так, как на других сайтах.
// например, при скроле вверх тоже подгружает, а на других сайтах нет
// при прокрутке подгружает слишком много постов
...
function insertPosts() {
    ...
    scrollCheck.innerHTML += postsMarkup;
}
